...
def fetch(subjects, action_filter=None, subset=1, parse_3d_poses=True):
    ...
    # print(out_camera_params)
    # print(type(out_camera_params))
    # print("2D:",out_poses_2d)
    # print("3D:",out_poses_3d)
    ...
    while epoch < args.epochs:
        ...
        if semi_supervised:
            ...
            for (_, batch_3d, batch_2d), (cam_semi, _, batch_2d_semi) in \
                ...
                print("Predicted 3d:",predicted_3d_pos)
...
if args.render:
    ...
    for frame_idx in range(prediction.shape[0]):
        frame_keypoints = prediction[frame_idx]
        pelvis = frame_keypoints[0]
        RHip = frame_keypoints[1]  
        Rknee = frame_keypoints[2] 
        Rfoot = frame_keypoints[3]  
        LHip = frame_keypoints[4]  
        Lknee = frame_keypoints[5]  
        Lfoot = frame_keypoints[6]  
        mid_spine = frame_keypoints[7]
        neck_base = frame_keypoints[8]
        head = frame_keypoints[9]
        site = frame_keypoints[10]
        Lshoulder = frame_keypoints[11]
        Lelbow = frame_keypoints[12]
        Lwrist = frame_keypoints[13]
        Rshoulder = frame_keypoints[14]
        Relbow = frame_keypoints[15]
        Rwrist = frame_keypoints[16]
        mid_shoulder = (np.array(Rshoulder) + np.array(Lshoulder)) / 2 
        ...
        reba_analysis_results.append({
                ...
                "angles": {
                    "neck": {
                        "angle": neck_flexion,
                        "side_bending": neck_sb,
                        "twisted": neck_rot,
                    },
                    "trunk": {
                        "angle": trunk_flexion,
                        "twisted": trunk_rot,
                        "side_bending":trunk_sb
                    },
                    "legs": {
                        "right_leg":{
                            "knee_angle":Rknee_angle,
                            "one_leg_raised": None
                        },
                        "left_leg": {
                    ...
                    "upper_arms": {
                        "right_arm":{
                            "angle": RUpperarm_angle,
                            "is_shoulder_raised":None,
                            "is_shoulder_abducted":Rabduction,
                            "is_supported":None
                        },
                        "left_arm": {
                            "angle":LUpperarm_angle,
                            "is_shoulder_raised":None,
                            "is_shoulder_abducted":Labduction,
                            "is_supported":None
                    }
                    },
                    "lower_arms": {
        ...
        angles['left_knee'].append(Lknee_angle)
        angles['right_knee'].append(Rknee_angle)
        angles['left_elbow'].append(Lelbow_angle)
        angles['right_elbow'].append(Relbow_angle)
        angles['left_upperarm'].append(LUpperarm_angle)
        angles['right_upperarm'].append(RUpperarm_angle)
        angles['neck_flexion'].append(neck_flexion)
        angles['neck_sb'].append(neck_sb)
        angles['neck_rot'].append(neck_rot)
        angles['trunk_flexion'].append(trunk_flexion)
        angles['trunk_sb'].append(trunk_sb)
        angles['trunk_rot'].append(trunk_rot)
        angles['Rabduction'].append(Rabduction)
        angles['Labduction'].append(Labduction)
...
# ------------------------------------------------------------------------------------------------------------------------------        
        ...
        render_animation(input_keypoints, keypoints_metadata, anim_output,
                         ...
                         input_video_skip=args.viz_skip, angles=angles)
